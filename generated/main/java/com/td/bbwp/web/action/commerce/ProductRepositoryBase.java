...
public interface ProductRepositoryBase extends BaseRepository<Product> {
	...
	Page<Product> findByNameContainingAllIgnoringCase(@Param("name") String name, Pageable pageable);

	Page<Product> findByName(@Param("name") String name, Pageable pageable);
	Page<Product> findByNameIgnoringCase(@Param("name") String name, Pageable pageable);
